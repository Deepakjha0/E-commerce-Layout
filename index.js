 var productList = [
  ...
  var assecoriesSection = document.getElementById("assecories-section")
...
for(i=0; i < productList.length; i++){
    ...
    if(productList[i].isAccessory == false){
        ...
        var texnodes = document.createTextNode(productList[i].name)
        var brandElement = document.createElement("p");
        var textnodes = document.createTextNode(productList[i].brand)
        var priceElement = document.createElement("p1")
        var priceNodes = document.createTextNode("Rs" + " " + productList[i].price)

        division.appendChild(img)
        clothingSection.appendChild(division)

        paraElement.appendChild(texnodes)
        division.appendChild(paraElement)
        clothingSection.appendChild(division)

        brandElement.appendChild(textnodes)
        division.appendChild(brandElement)
        clothingSection.appendChild(division)

        priceElement.appendChild(priceNodes)
        division.appendChild(priceElement)
        clothingSection.appendChild(division)
        ...
        division.appendChild(img)
        assecoriesSection.appendChild(division)
